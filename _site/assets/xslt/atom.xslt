...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://localhost:4000/chamcon/assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="»Cham Con« tong hop kinh nghiem cham soc con theo phuong phap khoa hoc.">
	<meta property="og:url" content="http://localhost:4000/chamcon/assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000/chamcon/search/">Search</a></li>
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/chamcon/design/">Suc khoe</a>
